...
Some examples:
  ...
  start: {
    title: "The Forest",
    description: `You wake up in a **forest**...
...
**WHAT SHOULD I DO?**`,
  ...
  castle: {
    title: "",
    description: `You finally reached the castle...
...
**WHAT SHOULD I DO?**`,
  ...
  forest: {
    title: "",
    description: `Is the same forest you've earlier.
  ...
  **WHAT SHOULD I DO?**`,
  ...
  help: {
    description: `Use text commands to walk around and do things.
Some examples:
    **go north**
    **get rope**
    **drop lantern**
